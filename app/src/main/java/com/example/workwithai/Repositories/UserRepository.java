...
import com.example.workwithai.Database.SqliteDbHelper;
...
public class UserRepository extends SqliteDbHelper {
    ...
    public boolean checkExistsUsername(String username) {
        ...
        //kiem tra du lieu trong bang user
    ...
    public UserModel loginUser(String username, String password){
        ...
        String[] cols = {USER_ID, USER_USERNAME, USER_PASSWORD, USER_EMAIL, USER_PHONE, USER_ROLE};
        ...
        if (data.getCount() > 0){
            ...
            user.setPassword(data.getString(data.getColumnIndex(USER_PASSWORD)));
