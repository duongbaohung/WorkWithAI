...
import com.example.workwithai.Adapters.ViewPageAdapter;
import com.example.workwithai.MainActivity;
...
public class MenuActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MenuItem itemUser = menu.findItem(R.id.acc_menu);
        if (username != null){
        ...
        bottomNav.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                } else if (menuItem.getItemId() == R.id.question_menu) { // Added Question Tab
    ...
    private void setupViewPager(){
        ...
        viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                } else if (position == 4) { // Added Question Tab
                    bottomNav.getMenu().findItem(R.id.question_menu).setChecked(true);
                } else {
                    bottomNav.getMenu().findItem(R.id.home_menu).setChecked(true);
                }
            }
