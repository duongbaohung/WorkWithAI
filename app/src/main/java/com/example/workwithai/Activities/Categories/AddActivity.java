package com.example.workwithai.Activities.Categories;
...
import com.example.workwithai.Repositories.CategoryRepository;
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name)){
                    edtName.setError("Please enter category name");
                    return;
                }
                ...
                //Success
                Toast.makeText(AddActivity.this, "Create Category successful", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(AddActivity.this, MenuActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString("MENU_TAB", "CATEGORY_TAB");
                intent.putExtras(bundle);
